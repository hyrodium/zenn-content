...
# はじめに
Julia言語には標準で[Pkg.jl](https://github.com/JuliaLang/Pkg.jl)が備わっており、パッケージ管理しやすい言語として知られています。
