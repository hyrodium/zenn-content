...
これら全部のファイルを毎回自分で用意するは大変なので、[PkgTemplates.jl](https://github.com/JuliaCI/PkgTemplates.jl)によって自動化する仕組みもあります。[^pkgtemplates]
しかし
...
個人的には`LICENSE`よりも`LICENSE.md`の方が自由度が高くて良いと思います。[Julia本体での`LICENSE.md`](https://github.com/JuliaLang/julia/blob/master/LICENSE.md)
