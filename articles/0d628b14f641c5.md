...
[^julia-parser]: この一覧は[src/julia-parser.scm](https://github.com/JuliaLang/julia/blob/v1.8.5/src/julia-parser.scm)から取得しました。
...
julia> a::Int ± b::Int = (a+b, a-b)
± (generic function with 2 methods)

julia> methods(±)
# 2 methods for generic function "±":
[1] ±(a::Int64, b::Int64) in Main at REPL[64]:1
[2] ±(a, b) in Main at REPL[60]:1
```
